...
while True:
    ...
    # Checks the gpa. Makes it so if it's greater than or equal to 3.5, prints only Dean's List
    if gpa >= 3.5:
        print(f"{first_name} {last_name} has made the Dean's List!")
    
    # Checks the gpa. Makes this one so if it's less than or equal to 3.25, prints only Honor Roll
    elif gpa >= 3.25:
